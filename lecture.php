                    ...
                    if(!est_progressif($conn,$courID,$nomCours)){
                        ...
                        if($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                <div class=\"course-item-text\">
                                <center><div class=\"cour-nom\">
                                <a style=\"color:white;font-weight:bold;display:".($chapitrePrecedentDone ? "":'none')."\" href=\"ressources_cours/$row[contenu]\" ><h4 class=\"button-text title-content\">". $row['contenu']."
