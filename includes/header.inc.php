         ...
         <div class="content" style="width:90%;height:90%;">
          ...
          <table>
            ...
            <div>
               ...
               <button class="main-btn" onclick="hidePopUp();document.querySelector('.side-bar').style.display='flex';document.getElementById('msg').style.display='none';">Fermer</button>
            </div>
         </div>
      </div>
